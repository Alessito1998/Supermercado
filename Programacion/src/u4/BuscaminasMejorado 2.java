		...
		public static void buscaBombas(String [][] matriz, String [][] tablero) {
			...
			//ESTE FOR ES PARA REPETIR EL PROCESO DE BÚSQUEDA
				...
				for(int i = 0; i <= contAux;) {
					...
					//SI HACEMOS EXPLOTAR LA BOMBA NOS DIRÁ QUE HEMOS PERDIDO E IMPRIMIRÁ EL TABLERO CON LA BOMBA EN ESA POSICIÓN
			...
			//CUANDO LA COLUMNA DE LA DERECHA NO EXISTE
				...
				if (perdedor = true) {
					...
					System.out.println("\nOh, no. Has perdido, había una bomba.\n");
					
				}
				
				else if (perdedor = false) {
