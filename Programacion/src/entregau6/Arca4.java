...
public class Arca4 {
	...
	//ANTES DE NADA ACLARAR QUE TENGO UN FOR BUGUEADO Y QUE PARTE DEL CÓDIGO ESTÁ CONDICIONADO POR ÉL
		...
		public static void buscaParejas() {
			...
			for (int n = 0; n < sexoAnimal.size(); n++) {
				...
				*/
				...
				if ((n + 1) < sexoAnimal.size()) {
					...
					System.out.println("Observador de n: " + n);
					...
					if (((sexoAnimal.get(n).equals(sexoAnimal.get(n + 1))) &&
						...
						((sexoAnimal.get(n).equals(sexoAnimal.get(n + 1))) &&
							...
							System.out.println("Observador 1 de Cont: " + cont);
				...
				/*
				  ...
				  ESTE IF SUMARÁ 1 EN EL CONTADOR AUXILIAR SIEMPRE QUE EL VALOR SIN LA ÚLTIMA LETRA SEA IGUAL A LA DE
				  
				  SU POSICIÓN HOMOLOGA CONTRARIA Y ADEMÁS, QUE SIEMPRE QUE EL VALOR DE LA ÚLTIMA LETRA SEA DIFERENTE A LA DE
				  
				  SU POSICIÓN HOMOLOGA CONTRARIA
				...
				*/
				...
				if ((n + 1) < sexoAnimal.size() && (block == false)) {
					...
					System.out.println("Observador 1 de ContAux: " + contAux);
					
					System.out.println("Observador 3 de Cont: " + cont);
			...
			//A CADA 4 A PARTIR DEL 6 HAY QUE RESTARLE 1 AL AUXILIAR
			
			//NADIE SABE POR QUÉ, PERO SINO NO FUNCIONA
			
			for (int n = 6; n <= numAnimales; n += 4) {
